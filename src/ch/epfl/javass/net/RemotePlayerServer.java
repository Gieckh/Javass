         ...
         BufferedWriter w =
           new BufferedWriter(
            ...
            while(!r.readLine().isEmpty()) {
                ...
                case TRMP:
                    this.underLyingPlayer.setTrump(Card.Color.ALL.get(
                            StringSerializer.deserializeInt(words[1])));
                    
                case HAND:
                    this.underLyingPlayer.updateHand(CardSet.ofPacked(
                            StringSerializer.deserializeLong(words[1])));
                
                case TRCK:
                    this.underLyingPlayer.updateTrick(Trick.ofPacked(
                            StringSerializer.deserializeInt(words[1])));
                ...
                default: throw new IllegalArgumentException("error in remote player ; wrong Jass Command");
            }
